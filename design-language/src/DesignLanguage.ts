...
import { thisbountyComStyleGuideTokens } from './designs/ThisbountyComStyleGuide.figma'
 ...
 *     `diez-thisbounty-styles-web`. Look for `App.jsx` inside `examples/web` to see
 ...
 *     called `DiezThisbountyStyles`. Look for `ViewController.swift` inside
